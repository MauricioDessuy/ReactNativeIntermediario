...
import { StyleSheet, Text, View, ScrollView, FlatList, SectionList, Picker } from 'react-native';
  ...
  render () {
    ...
    return (
      <View style={styles.body}>
        ...
        <Picker style={styles.picker} selectedValue={this.state.servico} onValueChange={(itemValue, itemIndex) => this.setState({servico: itemValue})}>
          {servicosItems}
        </Picker>
